...
def save_image_graph(G, labels, img_name):
    # Add display options
    options = {
    ...
    pylab.savefig('./img/{}.png'.format(img_name), dpi = 180)
    # pylab.show()
...
def main():
    ...
    for i in range(1, 20):
        ...
        # save_image_graph(G, edges, "{:0>3d}".format(i))
    ...
    print('Total execution duration:', time.time() - code_start_time, 'seconds\n')
